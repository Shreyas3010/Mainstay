...
<body>
<div class="bg-img"><button class="home1" onclick="location.href='homepage.php'" value="Homepage"><i class="fa fa-home"></i></button>
  <form style="margin-top:12%;" action = "provider_login01.php" method="post" class="container">
