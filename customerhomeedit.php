...
<button class="btn" onclick="location.href='customerhomeeditcancel.php'" ><i class="fa fa-close"></i></button>
<br><br>
<form action = "customerhomeedit01.php" method="post">
<table style="border:none;margin-left:550px;" cellspacing="20">
  <tr>
    <td style="cellpadding:10px;"><font class="a">Name :</font></td>
