...
<br>
<br>
<center><p class="ti">Stores in <?php echo $city?></p></center>
<?php
	//$a="provider".$ID;
	$result=mysqli_query($con,"SELECT * FROM provider WHERE pincode='$pincode' OR city='$city'");
	$pID=0;
	$di=3;
